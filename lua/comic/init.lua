...
--utils.high_link("NavbuddyName", "Normal")
--utils.high_link("NavbuddyScope", "Normal")
--utils.high_link("NavbuddyFloatBorder", "Normal")
--utils.high_link("NavbuddyNormalFloat", "Normal")

utils.high_link("NavbuddyFile", "Normal")
utils.high_link("NavbuddyModule", "Normal")
utils.high_link("NavbuddyNamespace", "Normal")
utils.high_link("NavbuddyPackage", "Normal")
utils.high_link("NavbuddyClass", "Normal")
utils.high_link("NavbuddyMethod", "Normal")
utils.high_link("NavbuddyProperty", "Normal")
utils.high_link("NavbuddyField", "Normal")
utils.high_link("NavbuddyConstructor", "Normal")
utils.high_link("NavbuddyEnum", "Normal")
utils.high_link("NavbuddyInterface", "Normal")
utils.high_link("NavbuddyFunction", "Normal")
utils.high_link("NavbuddyVariable", "Normal")
utils.high_link("NavbuddyConstant", "Normal")
utils.high_link("NavbuddyString", "Normal")
utils.high_link("NavbuddyNumber", "Normal")
utils.high_link("NavbuddyBoolean", "Normal")
utils.high_link("NavbuddyArray", "Normal")
utils.high_link("NavbuddyObject", "Normal")
utils.high_link("NavbuddyKey", "Normal")
utils.high_link("NavbuddyNull", "Normal")
utils.high_link("NavbuddyEnumMember", "Normal")
utils.high_link("NavbuddyStruct", "Normal")
utils.high_link("NavbuddyEvent", "Normal")
utils.high_link("NavbuddyOperator", "Normal")
utils.high_link("NavbuddyTypeParameter", "Normal")
